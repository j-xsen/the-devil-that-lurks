...
292 25 ParametricCurveCollection 0 4 522 52 ParametricCurveCollection::ParametricCurveCollection 0 2 23 24 10
/**
 *
 */
165
...
323 11 CurveFitter 0 4 527 24 CurveFitter::CurveFitter 0 2 61 62 10
/**
 *
 */
95
...
324 12 ~CurveFitter 0 4 527 25 CurveFitter::~CurveFitter 0 0 10
/**
 *
 */
32
...
345 14 PiecewiseCurve 0 4 528 30 PiecewiseCurve::PiecewiseCurve 0 1 83 10
/**
 *
 */
37
...
347 12 HermiteCurve 0 4 529 26 HermiteCurve::HermiteCurve 0 2 85 86 92
/**
 *
 */
...
367 20 ~NurbsCurveInterface 0 6 530 41 NurbsCurveInterface::~NurbsCurveInterface 0 0 10
/**
 *
 */
56
...
390 10 NurbsCurve 0 4 531 22 NurbsCurve::NurbsCurve 0 2 134 135 188
/**
 *
 */
...
391 11 ~NurbsCurve 0 6 531 23 NurbsCurve::~NurbsCurve 0 0 10
/**
 *
 */
38
...
409 16 NurbsCurveResult 0 4 532 34 NurbsCurveResult::NurbsCurveResult 0 1 139 174
/**
...
410 19 NurbsCurveEvaluator 0 4 533 40 NurbsCurveEvaluator::NurbsCurveEvaluator 0 2 156 157 10
/**
 *
 */
135
...
445 18 NurbsSurfaceResult 0 4 534 38 NurbsSurfaceResult::NurbsSurfaceResult 0 1 180 174
/**
 * The constructor automatically builds up the result as the product of the
 * indicated set of basis matrices and the indicated table of control vertex
 * positions.
...
446 21 NurbsSurfaceEvaluator 0 4 535 44 NurbsSurfaceEvaluator::NurbsSurfaceEvaluator 0 2 197 198 10
/**
 *
 */
145
...
473 8 RopeNode 0 4 537 18 RopeNode::RopeNode 0 1 228 22
/**
 *
 */
...
506 9 ~RopeNode 0 4 537 19 RopeNode::~RopeNode 0 0 0
26
RopeNode::~RopeNode(void);

507 9 SheetNode 0 4 549 20 SheetNode::SheetNode 0 1 261 22
/**
 *
 */
...
518 10 ~SheetNode 0 4 549 21 SheetNode::~SheetNode 0 0 0
28
 ...
 * Writes an egg description of the nurbs curve to the specified output file.
 * Returns true if the file is successfully written.
 */ 3 4 this 3 524  8 filename 1 556  2 cs 1 558  
 ...
 *
 */ 0 
24 0 0 7 26 565 0 0 0 1 6 param0 0 566  
 ...
 * by all the timewarp curves and within the bounds of the curves themselves),
 * or false otherwise.
 */ 4 4 this 3 566  1 t 1 525  6 result 1 571  2 cs 1 558  
 ...
 * Writes a complete multi-line description of the ParametricCurveCollection
 * to the indicated output stream.
 */ 3 4 this 3 566  3 out 1 559  12 indent_level 1 536  
59 0 0 6 67 542 0 0 162 /**
 * Writes an egg description of all the nurbs curves in the collection to the
 * specified output file.  Returns true if the file is successfully written.
 */ 3 4 this 3 565  8 filename 1 556  2 cs 1 558  
 ...
 *
 */ 0 
62 0 0 7 69 574 324 0 0 1 6 param0 0 575  
...
139 0 0 7 164 593 0 0 0 1 6 param0 0 591  
 ...
 *
 */ 0 
157 0 0 7 166 541 0 0 0 1 6 param0 0 599  
 ...
 * 3-d coordinate and a weight; the 3-d coordinate values are implicitly
 * scaled up by the weight factor.
 */ 4 4 this 3 541  1 i 1 536  6 vertex 1 572  6 weight 1 525  
...
180 0 0 7 204 610 0 0 0 1 6 param0 0 608  
 ...
 *
 */ 0 
198 0 0 7 206 611 0 0 0 1 6 param0 0 612  
 ...
 * a 3-d coordinate and a weight; the 3-d coordinate values are implicitly
 * scaled up by the weight factor.
 */ 5 4 this 3 611  2 ui 1 536  2 vi 1 536  6 vertex 1 572  6 weight 1 525  
