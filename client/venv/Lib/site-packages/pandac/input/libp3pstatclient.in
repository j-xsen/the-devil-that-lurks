...
94 14 PStatCollector 0 4 147 30 PStatCollector::PStatCollector 0 3 31 32 33 1708
/**
...
118 15 ~PStatCollector 0 4 147 31 PStatCollector::~PStatCollector 0 0 0
38
PStatCollector::~PStatCollector(void);

119 11 PStatThread 0 4 148 24 PStatThread::PStatThread 0 3 68 69 70 446
/**
 * Normally, this constructor is called only from PStatClient.  Use one of the
...
125 12 ~PStatThread 0 4 148 25 PStatThread::~PStatThread 0 0 0
32
...
139 21 PStatCollectorForward 0 4 151 44 PStatCollectorForward::PStatCollectorForward 0 1 76 10
/**
 *
 */
79
...
140 22 ~PStatCollectorForward 0 4 151 45 PStatCollectorForward::~PStatCollectorForward 0 0 0
52
 ...
 * something.
 */ 1 4 this 3 156  
18 0 0 6 71 162 0 0 125 /**
 * Attempts to establish a connection to the indicated PStatServer.  Returns
 * true if successful, false on failure.
 */ 2 8 hostname 1 154  4 port 1 150  
19 0 0 4 72 155 0 0 56 /**
 * Closes the connection previously established.
 */ 0 
...
26 0 0 6 79 162 0 0 53 /**
 * The nonstatic implementation of connect().
 */ 3 4 this 3 153  8 hostname 1 154  4 port 1 150  
27 0 0 4 80 155 0 0 56 /**
 * The nonstatic implementation of disconnect().
 */ 1 4 this 3 153  
 ...
 * PStatClient.
 */ 1 4 this 3 163  
68 0 0 7 57 161 125 0 135 /**
 * Normally, this constructor is called only from PStatClient.  Use one of the
 * constructors below to create your own Thread.
 */ 2 6 client 1 153  5 index 1 150  
69 0 0 7 57 161 125 0 10 /**
 *
 */ 1 4 copy 1 167  
70 0 0 7 57 161 125 0 160 /**
 * Creates a new named thread.  This will be used to unify tasks that share a
 * common thread, and differentiate tasks that occur in different threads.
 */ 2 6 thread 1 149  6 client 1 153  
