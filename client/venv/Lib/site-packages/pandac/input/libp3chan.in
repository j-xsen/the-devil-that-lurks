...
215 9 AnimGroup 0 4 432 20 AnimGroup::AnimGroup 0 2 1 2 607
...
216 10 ~AnimGroup 0 6 432 21 AnimGroup::~AnimGroup 0 0 10
/**
 *
 */
36
...
225 10 AnimBundle 0 4 436 22 AnimBundle::AnimBundle 0 2 13 14 207
/**
 *
 */
...
230 11 ~AnimBundle 0 4 436 23 AnimBundle::~AnimBundle 0 0 0
30
AnimBundle::~AnimBundle(void);

231 14 AnimBundleNode 0 4 439 30 AnimBundleNode::AnimBundleNode 0 1 19 330
/**
...
235 15 ~AnimBundleNode 0 4 439 31 AnimBundleNode::~AnimBundleNode 0 0 0
38
...
240 9 PartGroup 0 4 442 20 PartGroup::PartGroup 0 1 23 501
...
241 10 ~PartGroup 0 6 442 21 PartGroup::~PartGroup 0 0 10
/**
 *
 */
36
...
265 12 ~AnimControl 0 6 445 25 AnimControl::~AnimControl 0 0 10
/**
 *
 */
40
...
281 16 ~AnimChannelBase 0 4 448 33 AnimChannelBase::~AnimChannelBase 0 0 0
40
...
305 25 ~AnimChannelMatrixDynamic 0 4 455 51 AnimChannelMatrixDynamic::~AnimChannelMatrixDynamic 0 0 0
58
AnimChannelMatrixDynamic::~AnimChannelMatrixDynamic(void);

306 25 AnimChannelMatrixXfmTable 0 4 457 52 AnimChannelMatrixXfmTable::AnimChannelMatrixXfmTable 0 1 83 248
/**
...
319 25 ~AnimChannelScalarDynamic 0 4 461 51 AnimChannelScalarDynamic::~AnimChannelScalarDynamic 0 0 0
58
AnimChannelScalarDynamic::~AnimChannelScalarDynamic(void);

320 22 AnimChannelScalarTable 0 4 464 46 AnimChannelScalarTable::AnimChannelScalarTable 0 1 94 220
/**
 *
 */
...
326 23 ~AnimChannelScalarTable 0 4 464 47 AnimChannelScalarTable::~AnimChannelScalarTable 0 0 0
54
AnimChannelScalarTable::~AnimChannelScalarTable(void);

327 21 AnimControlCollection 0 4 465 44 AnimControlCollection::AnimControlCollection 0 2 100 101 117
/**
...
328 22 ~AnimControlCollection 0 4 465 45 AnimControlCollection::~AnimControlCollection 0 0 10
/**
 *
 */
52
...
350 16 AnimPreloadTable 0 4 466 34 AnimPreloadTable::AnimPreloadTable 0 1 130 10
/**
 *
 */
41
...
364 10 PartSubset 0 4 468 22 PartSubset::PartSubset 0 2 143 144 22
/**
 *
 */
...
373 11 ~PartSubset 0 4 468 23 PartSubset::~PartSubset 0 0 0
30
PartSubset::~PartSubset(void);

374 15 BindAnimRequest 0 4 469 32 BindAnimRequest::BindAnimRequest 0 2 153 154 10
/**
 *
 */
290
...
376 16 ~BindAnimRequest 0 4 469 33 BindAnimRequest::~BindAnimRequest 0 0 0
40
BindAnimRequest::~BindAnimRequest(void);

377 10 PartBundle 0 4 471 22 PartBundle::PartBundle 0 1 156 220
/**
...
395 14 PartBundleNode 0 4 476 30 PartBundleNode::PartBundleNode 0 1 189 388
/**
...
399 16 PartBundleHandle 0 4 479 34 PartBundleHandle::PartBundleHandle 0 2 194 195 10
/**
 *
 */
141
...
416 11 ~PartBundle 0 4 471 23 PartBundle::~PartBundle 0 0 0
30
...
421 15 ~MovingPartBase 0 4 481 31 MovingPartBase::~MovingPartBase 0 0 0
38
...
425 11 ~MovingPart 0 4 483 45 MovingPart< ACMatrixSwitchType >::~MovingPart 0 0 0
52
...
430 11 ~MovingPart 0 4 485 45 MovingPart< ACScalarSwitchType >::~MovingPart 0 0 0
52
...
2 0 0 7 8 435 216 0 0 1 6 param0 0 487  
...
13 0 0 7 22 441 230 0 0 1 6 param0 0 496  
 ...
 * control has been associated.
 */ 0 
101 0 0 7 163 547 328 0 0 1 6 param0 0 548  
 ...
 * false otherwise.
 */ 2 4 this 3 554  10 joint_name 1 486  
153 0 0 7 217 561 376 0 0 1 6 param0 0 559  
 ...
 * unbind itself when the AnimControl destructs (i.e.  its reference count
 * goes to zero).
 */ 4 4 this 3 477  4 anim 1 441  21 hierarchy_match_flags 1 438  6 subset 1 554  
...
194 0 0 7 262 478 0 0 10 /**
 *
 */ 1 6 bundle 1 477  
195 0 0 7 262 478 0 0 0 1 6 param0 0 574  
...
210 0 0 4 203 489 0 0 0 3 9 root_node 1 456  8 controls 1 547  21 hierarchy_match_flags 1 438  
150
