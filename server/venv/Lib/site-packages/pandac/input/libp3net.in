...
171 9 PointerTo 0 4 344 34 PointerTo< Connection >::PointerTo 0 4 1 2 3 4 0
317
...
176 10 ~PointerTo 0 4 344 35 PointerTo< Connection >::~PointerTo 0 0 0
42
PointerTo< Connection >::~PointerTo(void);

177 10 NetAddress 0 4 347 22 NetAddress::NetAddress 0 3 12 13 14 271
/**
...
194 11 ~NetAddress 0 4 347 23 NetAddress::~NetAddress 0 0 0
30
NetAddress::~NetAddress(void);

195 10 Connection 0 4 348 22 Connection::Connection 0 1 31 177
/**
...
214 17 ~ConnectionReader 0 6 350 35 ConnectionReader::~ConnectionReader 0 0 10
/**
 *
 */
50
...
227 19 ~ConnectionListener 0 4 351 39 ConnectionListener::~ConnectionListener 0 0 0
46
ConnectionListener::~ConnectionListener(void);

228 11 NetDatagram 0 4 352 24 NetDatagram::NetDatagram 0 3 62 63 64 130
/**
...
235 12 ~NetDatagram 0 4 352 25 NetDatagram::~NetDatagram 0 0 0
32
NetDatagram::~NetDatagram(void);

236 17 ConnectionManager 0 4 354 36 ConnectionManager::ConnectionManager 0 1 72 10
/**
 *
 */
43
...
237 18 ~ConnectionManager 0 6 354 37 ConnectionManager::~ConnectionManager 0 0 10
/**
 *
 */
52
...
255 9 Interface 0 4 355 39 ConnectionManager::Interface::Interface 0 1 86 0
95
inline ConnectionManager::Interface::Interface(ConnectionManager::Interface const &) = default;

256 10 ~Interface 0 4 355 40 ConnectionManager::Interface::~Interface 0 0 0
47
...
260 16 ConnectionWriter 0 4 359 34 ConnectionWriter::ConnectionWriter 0 1 98 224
/**
...
261 17 ~ConnectionWriter 0 4 359 35 ConnectionWriter::~ConnectionWriter 0 0 10
/**
 *
 */
42
...
286 20 DatagramGeneratorNet 0 4 360 42 DatagramGeneratorNet::DatagramGeneratorNet 0 1 113 243
/**
...
287 21 ~DatagramGeneratorNet 0 6 360 43 DatagramGeneratorNet::~DatagramGeneratorNet 0 0 10
/**
 *
 */
58
...
295 15 DatagramSinkNet 0 4 363 32 DatagramSinkNet::DatagramSinkNet 0 1 125 233
/**
...
301 16 ~DatagramSinkNet 0 4 363 33 DatagramSinkNet::~DatagramSinkNet 0 0 0
40
...
311 24 QueuedConnectionListener 0 4 365 50 QueuedConnectionListener::QueuedConnectionListener 0 1 133 10
/**
 *
 */
105
...
312 25 ~QueuedConnectionListener 0 6 365 51 QueuedConnectionListener::~QueuedConnectionListener 0 0 10
/**
 *
 */
66
...
324 23 QueuedConnectionManager 0 4 367 48 QueuedConnectionManager::QueuedConnectionManager 0 1 144 10
/**
 *
 */
55
...
325 24 ~QueuedConnectionManager 0 6 367 49 QueuedConnectionManager::~QueuedConnectionManager 0 0 10
/**
 *
 */
64
...
337 22 QueuedConnectionReader 0 4 369 46 QueuedConnectionReader::QueuedConnectionReader 0 1 154 10
/**
 *
 */
101
...
338 23 ~QueuedConnectionReader 0 6 369 47 QueuedConnectionReader::~QueuedConnectionReader 0 0 10
/**
 *
 */
62
...
341 22 RecentConnectionReader 0 4 371 46 RecentConnectionReader::RecentConnectionReader 0 1 165 10
/**
 *
 */
84
...
2 0 0 7 6 372 176 0 0 1 3 ptr 1 373  
3 0 0 7 6 372 176 0 0 1 4 copy 1 373  
 ...
 * Constructs an unspecified address.
 */ 0 
13 0 0 7 13 384 194 0 0 1 6 param0 0 385  
14 0 0 7 13 384 194 0 224 /**
 * Constructs an address from a given Socket_Address.  Normally, this
 * constructor should not be used by user code; instead, create a default
 * NetAddress and use one of the set_*() functions to set up an address.
 */ 1 4 addr 1 387  
 ...
 * Constructs an empty datagram.
 */ 0 
63 0 0 7 70 407 235 0 10 /**
 *
 */ 1 4 copy 1 408  
64 0 0 7 70 407 235 0 10 /**
 *
 */ 1 4 copy 1 410  
 ...
 * Use a ConnectionReader and ConnectionWriter to handle the actual
 * communication.
 */ 4 4 this 3 398  8 hostname 1 391  4 port 1 414  13 for_broadcast 1 377  
...
86 0 0 7 99 417 256 0 0 1 6 param0 0 416  
 ...
 * If num_threads is 0, all datagrams will be sent immediately instead of
 * queueing for later transmission by a thread.
 */ 3 7 manager 1 398  11 num_threads 1 390  11 thread_name 1 391  
 ...
 * If block is true, this will not return false if the send queue is filled;
 * instead, it will wait until there is space available.
 */ 5 4 this 3 418  8 datagram 1 408  10 connection 1 373  7 address 1 385  5 block 1 377  
 ...
 * If block is true, this will not return false if the send queue is filled;
 * instead, it will wait until there is space available.
 */ 4 4 this 3 418  8 datagram 1 408  10 connection 1 373  5 block 1 377  
