...
110 12 ~TrackerData 0 4 237 25 TrackerData::~TrackerData 0 0 0
32
...
115 11 ButtonState 0 4 251 37 InputDevice::ButtonState::ButtonState 0 1 20 10
/**
 *
 */
89
...
116 12 ~ButtonState 0 4 251 38 InputDevice::ButtonState::~ButtonState 0 0 0
45
...
124 9 AxisState 0 4 254 33 InputDevice::AxisState::AxisState 0 1 22 0
83
inline InputDevice::AxisState::AxisState(InputDevice::AxisState const &) = default;

125 10 ~AxisState 0 4 254 34 InputDevice::AxisState::~AxisState 0 0 0
41
...
130 11 BatteryData 0 4 255 37 InputDevice::BatteryData::BatteryData 0 2 24 25 0
151
...
131 12 ~BatteryData 0 4 255 38 InputDevice::BatteryData::~BatteryData 0 0 0
45
...
174 10 AnalogNode 0 4 266 22 AnalogNode::AnalogNode 0 3 33 34 35 22
/**
 *
 */
...
184 10 ButtonNode 0 4 268 22 ButtonNode::ButtonNode 0 3 45 46 47 22
/**
 *
 */
...
192 8 DialNode 0 4 269 18 DialNode::DialNode 0 2 55 56 10
/**
 *
 */
135
...
198 14 InputDeviceSet 0 4 270 30 InputDeviceSet::InputDeviceSet 0 2 62 63 22
/**
 *
 */
...
200 15 ~InputDeviceSet 0 4 270 31 InputDeviceSet::~InputDeviceSet 0 0 10
/**
 *
 */
45
...
212 15 InputDeviceNode 0 4 272 32 InputDeviceNode::InputDeviceNode 0 2 77 78 0
155
...
216 16 ~InputDeviceNode 0 4 272 33 InputDeviceNode::~InputDeviceNode 0 0 0
40
InputDeviceNode::~InputDeviceNode(void);

217 11 TrackerNode 0 4 274 24 TrackerNode::TrackerNode 0 3 80 81 82 22
/**
 *
 */
...
229 12 VirtualMouse 0 4 275 26 VirtualMouse::VirtualMouse 0 2 94 95 10
/**
 *
 */
128
...
236 13 ~VirtualMouse 0 4 275 27 VirtualMouse::~VirtualMouse 0 0 0
34
 ...
 * may change as more axes are discovered.
 */ 1 4 this 3 276  
20 0 0 7 38 283 116 0 0 1 6 param0 0 293  
21 0 0 6 29 252 0 0 0 1 4 this 3 283  
22 0 0 7 51 284 125 0 0 1 6 param0 0 295  
23 0 0 6 41 252 0 0 0 1 4 this 3 284  
24 0 0 7 61 297 131 0 0 0 
25 0 0 7 61 297 131 0 0 1 6 param0 0 298  
...
33 0 0 7 132 306 0 0 0 1 6 param0 0 304  
...
45 0 0 7 143 311 0 0 0 1 6 param0 0 309  
 ...
 *
 */ 2 6 client 1 300  11 device_name 1 307  
56 0 0 7 152 312 0 0 0 1 6 param0 0 313  
 ...
 * Writes a complete multi-line description of the InputDeviceSet to the
 * indicated output stream.
 */ 3 4 this 3 316  3 out 1 289  12 indent_level 1 308  
 ...
 * Returns the singleton InputDeviceManager instance.
 */ 0 
77 0 0 7 175 321 216 0 0 2 6 device 1 278  4 name 1 307  
78 0 0 7 175 321 216 0 0 1 6 param0 0 322  
 ...
 *
 */ 1 6 device 1 278  
82 0 0 7 183 324 0 0 0 1 6 param0 0 325  
...
94 0 0 7 196 335 236 0 0 1 6 param0 0 333  
