...
180 10 ~LightNode 0 4 369 21 LightNode::~LightNode 0 0 0
28
LightNode::~LightNode(void);

181 12 AmbientLight 0 4 372 26 AmbientLight::AmbientLight 0 1 6 138
/**
 *
 */
...
183 13 ~AmbientLight 0 4 372 27 AmbientLight::~AmbientLight 0 0 0
34
AmbientLight::~AmbientLight(void);

184 12 CallbackNode 0 4 373 26 CallbackNode::CallbackNode 0 1 8 22
/**
 *
 */
...
192 13 ~CallbackNode 0 4 373 27 CallbackNode::~CallbackNode 0 0 0
34
CallbackNode::~CallbackNode(void);

193 11 ComputeNode 0 4 376 24 ComputeNode::ComputeNode 0 1 16 134
/**
...
202 12 ~ComputeNode 0 4 376 25 ComputeNode::~ComputeNode 0 0 0
32
...
207 14 ~LightLensNode 0 6 380 29 LightLensNode::~LightLensNode 0 0 10
/**
 *
 */
44
...
218 16 DirectionalLight 0 4 384 34 DirectionalLight::DirectionalLight 0 1 39 138
/**
 *
 */
...
227 17 ~DirectionalLight 0 4 384 35 DirectionalLight::~DirectionalLight 0 0 0
42
DirectionalLight::~DirectionalLight(void);

228 7 LODNode 0 4 395 16 LODNode::LODNode 0 1 47 22
/**
 *
 */
...
251 8 ~LODNode 0 4 395 17 LODNode::~LODNode 0 0 0
24
LODNode::~LODNode(void);

252 11 FadeLODNode 0 4 399 24 FadeLODNode::FadeLODNode 0 1 71 22
/**
 *
 */
...
261 12 ~FadeLODNode 0 4 399 25 FadeLODNode::~FadeLODNode 0 0 0
32
...
265 10 PointLight 0 4 405 22 PointLight::PointLight 0 1 83 138
/**
 *
 */
...
276 11 ~PointLight 0 4 405 23 PointLight::~PointLight 0 0 0
30
PointLight::~PointLight(void);

277 14 RectangleLight 0 4 409 30 RectangleLight::RectangleLight 0 1 92 138
/**
 *
 */
...
281 15 ~RectangleLight 0 4 409 31 RectangleLight::~RectangleLight 0 0 0
38
RectangleLight::~RectangleLight(void);

282 18 SelectiveChildNode 0 4 410 38 SelectiveChildNode::SelectiveChildNode 0 1 96 22
/**
 *
 */
...
284 19 ~SelectiveChildNode 0 4 410 39 SelectiveChildNode::~SelectiveChildNode 0 0 0
46
...
289 12 SequenceNode 0 4 411 26 SequenceNode::SequenceNode 0 1 98 22
/**
 *
 */
...
294 13 ~SequenceNode 0 4 411 27 SequenceNode::~SequenceNode 0 0 0
34
SequenceNode::~SequenceNode(void);

295 15 ShaderGenerator 0 4 414 32 ShaderGenerator::ShaderGenerator 0 2 104 105 189
/**
...
300 11 SphereLight 0 4 416 24 SphereLight::SphereLight 0 1 110 138
/**
 *
 */
...
304 12 ~SphereLight 0 4 416 25 SphereLight::~SphereLight 0 0 0
32
SphereLight::~SphereLight(void);

305 9 Spotlight 0 4 417 20 Spotlight::Spotlight 0 1 114 138
/**
 *
 */
...
317 10 ~Spotlight 0 4 417 21 Spotlight::~Spotlight 0 0 0
28
Spotlight::~Spotlight(void);

318 10 SwitchNode 0 4 418 22 SwitchNode::SwitchNode 0 1 123 22
/**
 *
 */
...
322 11 ~SwitchNode 0 4 418 23 SwitchNode::~SwitchNode 0 0 0
30
SwitchNode::~SwitchNode(void);

323 12 UvScrollNode 0 4 419 26 UvScrollNode::UvScrollNode 0 2 127 128 34
/**
 *
 */
...
333 13 ~UvScrollNode 0 4 419 27 UvScrollNode::~UvScrollNode 0 0 0
34
UvScrollNode::~UvScrollNode(void);

334 18 SceneGraphAnalyzer 0 4 420 38 SceneGraphAnalyzer::SceneGraphAnalyzer 0 2 138 139 10
/**
 *
 */
130
...
335 19 ~SceneGraphAnalyzer 0 4 420 39 SceneGraphAnalyzer::~SceneGraphAnalyzer 0 0 10
/**
 *
 */
46
 ...
 *
 */ 3 4 this 3 422  3 out 1 424  12 indent_level 1 398  
 ...
 * will be set up, the sort parameter specifies the sort.  Note that enabling
 * shadows will require the shader generator to be enabled on the scene.
 */ 5 4 this 3 445  6 caster 1 382  12 buffer_xsize 1 398  12 buffer_ysize 1 398  4 sort 1 398  
 ...
 *
 */ 3 4 this 3 443  3 out 1 424  12 indent_level 1 398  
...
104 0 0 7 197 486 0 0 189 /**
 * Create a ShaderGenerator.  This has no state, except possibly to cache
 * certain results.  The parameter that must be passed is the GSG to which the
 * shader generator belongs.
 */ 1 3 gsg 1 484  
105 0 0 7 197 486 0 0 0 1 6 param0 0 487  
 ...
 *
 */ 0 
139 0 0 7 251 513 335 0 0 1 6 param0 0 514  
 ...
 * Describes all the data collected.
 */ 3 4 this 3 514  3 out 1 424  12 indent_level 1 398  
